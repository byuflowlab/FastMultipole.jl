...
function FastGaussSeidel(target_systems::Tuple, source_systems::Tuple; 
    ...
    target_tree = Tree(target_systems, true; expansion_order, leaf_size, shrink, recenter, interaction_list_method)
    source_tree = Tree(source_systems, false; expansion_order, leaf_size, shrink, recenter, interaction_list_method)
