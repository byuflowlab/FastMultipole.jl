# T1 — Scalar Recurrence

## Objective

Derive the third complex solid-harmonic differentiation pass, coefficient orientation, and full scalar symmetry. Prototype packed-18 output and compare nested derivatives of 1/r with ForwardDiff.
