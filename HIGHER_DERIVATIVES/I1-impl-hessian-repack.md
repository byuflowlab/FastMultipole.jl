# I1 — Compatibility and Tensor API

## Objective

Preserve the 9-row Hessian bit-for-bit. Add the compressed tensor type, indexing, buffer helpers, exports, probe storage, compatible probe constructors, and layout regressions.
