...
# 033 checksummed sampled-direct references (accuracy instrument)
ssh "$REMOTE" "mkdir -p $FMDIR/MATRIX_OPERATOR_REFACTOR/data/flowvpm_baseline $FMDIR/MATRIX_OPERATOR_REFACTOR/data/flowvpm_gpu_campaign"
rsync -az --delete \
