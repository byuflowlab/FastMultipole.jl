# fm041k_erf_vendored.jl — verbatim copy of ../FLOWVPM.jl/src/FLOWVPM_gpu_erf.jl
# (branch gpu-full, fetched 2026-08-20) so the 041k brute-force benchmark is
# standalone while bit-matching FLOWVPM's production erf on CPU and in CUDA
# kernels, both precisions. Do not edit; re-vendor from FLOWVPM if it changes.
